...
for epoch in range(num_epochs):
    ...
    avg_train_loss, train_acc = train(train_dataloader, optimizer , scheduler
            , device, epoch)
    print('Average train loss: ', avg_train_loss)
    epoch_train_accuracy.append(train_acc)
    epoch_avg_train_loss.append(avg_train_loss)
    torch.save(model, "bert_sentiment_classifier.pth")
...
df_test.to_csv('bert_pred.csv', index=False)

print(accuracy_score(df_test['sentiment'].values, df_test['prediction'].values))
print(classification_report(df_test['sentiment'].values, df_test['prediction'].values))
